...
namespace socketio {
  ...
  class socketio_client_handler : public client<websocketpp::config::asio_client>::message_handler {
  public:
    ...
    void set_client(websocketpp::client<websocketpp::config::asio_client> * ptr )
    {
      m_client = ptr;
    }
